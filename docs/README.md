# musicbrainz-graph-enricher documentation

- [Graph enrichment](graph-enrichment.md): Neo4j properties and relationship outputs
- [MusicBrainz event flow](musicbrainz-sync.md): inputs, queues, and service boundary
- [Consumer cancellation](consumer-cancellation.md): completion and shutdown behavior
