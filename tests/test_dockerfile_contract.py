...
def test_image_metadata_uses_repository_name() -> None:
    assert 'org.opencontainers.image.title="musicbrainz-graph-enricher"' in DOCKERFILE
    assert "github.com/groovemap-music/musicbrainz-graph-enricher" in DOCKERFILE
